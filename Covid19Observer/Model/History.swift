...
//        DispatchQueue.global().async {
            ...
            for countryCase in self.countryRows {
                ...
                if History.countriesWithRegions.contains(country) {
                    ...
                    if visitedCountries.contains(country) {
                        ...
                        last8days = Array(self.series(for: country).suffix(8))
                    }
                } else {
                ...
                let isGreaterThanThreshold = last >= self.deviationThreshold || avg >= self.deviationThreshold
